...
// // Dom is responsible for making our web page interactive and dynamic
// console.log(document)// give full html file 
...
// console.log(qs1);//full tag given
// let qs2=document.querySelector("div,.container,#box1")
// console.log(qs2);//full tag given
// ////////////////
...
// let mainTag=document.querySelector("#main-container");
// console.log(mainTag);
...
// pTag.innerHTML="p tag?  <h1>bhbb</h1> ";// here in string consider tags also not treat them as a text
...
// }
// //singleClick() call by html files in attribute 
...
//     console.log("mouse button is bahar aa gya h");
// }
